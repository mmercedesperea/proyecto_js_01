$(document).ready(function () {
    ...
    if ((window.location.href.indexOf('index') > -1) || (window.location.href.indexOf('') > -1) )  { // para comprobar de que la pagina tiene en su URL Index (que index sea mayor que -1)para que no de error si no es asi
